...
## search_code
Description: Request to search for code in the specified directory using a semantic search. This tool searches for code in the specified directory using a semantic search.
Parameters:
